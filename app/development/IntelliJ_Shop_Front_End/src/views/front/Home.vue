  ...
  <div class="main-content">
    ...
    <div style="display: flex;">
      ...
      <div style="width: 75%; background-color: white;">
        <div style="margin: 20px 15px; height: 40px; background-color: #04BF04FF; font-size: 20px; color: white; width: 130px; font-weight: bold; line-height: 40px; text-align: center; border-radius: 20px">主题市场</div>
        <div style="display: flex; margin: 0 25px; height: 550px;">
          <div style="flex: 2;">
            <div style="display: flex; color: #666666; margin: 14px 0;" v-for="item in typeData" :key="item.id">
              <img :src="item.img" alt="" style="width: 20px; height: 20px; margin-left: 30px;">
              <div style="margin-left: 10px; font-size: 23px;"><a href="#" @click="navTo('/front/type?id=' + item.id)">{{ item.name }}</a></div>
            </div>
          </div>
          ...
          <div style="flex: 2; background-color: #f3f3f3ff; margin-top: 15px; margin-left: 15px;border-radius: 10px;">
            ...
            <div style="margin-top: 20px; padding: 0 15px">
              <img src="@/assets/imgs/right.png" alt="" style="height: 220px; width: 100%; border-radius: 20px">
            </div>
            <div style="margin-top: 20px; width: 250px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis">
            ...
            <div style="display: flex; margin-top: 20px">
              <div style="flex: 1; text-align: center">
                <a href="#" @click="navTo('/front/collect')">
                  <img src="@/assets/imgs/收藏.png" alt="" style="height: 50px; width: 50px">
                  <div>我的收藏</div>
                </a>
              </div>
              <div style="flex: 1; text-align: center">
                <a href="#" @click="navTo('/front/address')">
                  <img src="@/assets/imgs/地址.png" alt="" style="height: 50px; width: 50px">
                  <div>我的地址</div>
                </a>
              </div>
              <div style="flex: 1; text-align: center">
                <a href="#" @click="navTo('/front/cart')">
                  <img src="@/assets/imgs/购物车.png" alt="" style="height: 50px; width: 50px">
                  <div>购物车</div>
                </a>
              </div>
              <div style="flex: 1; text-align: center">
                <a href="#" @click="navTo('/front/orders')">
                  <img src="@/assets/imgs/订单.png" alt="" style="height: 50px; width: 50px">
                  <div>我的订单</div>
                </a>
              </div>
            </div>
